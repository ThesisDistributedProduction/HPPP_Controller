...
#ifndef RequestMessagePlugin_1502787215_h
#define RequestMessagePlugin_1502787215_h
...
#define RequestMessagePlugin_get_sample PRESTypePluginDefaultEndpointData_getSample  
#define RequestMessagePlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define RequestMessagePlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 
 

#define RequestMessagePlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define RequestMessagePlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

/* --------------------------------------------------------------------------------------
    Support functions:
 * -------------------------------------------------------------------------------------- */

NDDSUSERDllExport extern RequestMessage*
...
NDDSUSERDllExport extern RTIBool 
RequestMessagePlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    RequestMessage * sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern RTIBool 
RequestMessagePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    RequestMessage ** sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
RequestMessagePlugin_new(void);

NDDSUSERDllExport extern void
RequestMessagePlugin_delete(struct PRESTypePlugin *);
...
#endif /* RequestMessagePlugin_1502787215_h */
