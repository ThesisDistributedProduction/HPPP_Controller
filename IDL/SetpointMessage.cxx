...
RTIBool SetpointMessage_initialize_w_params(
    SetpointMessage* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
...
void SetpointMessage_finalize_w_params(
    SetpointMessage* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
{
