...
#ifndef RequestMessage_1502787213_h
#define RequestMessage_1502787213_h
...
RTIBool RequestMessage_initialize_ex(
        RequestMessage* self,RTIBool allocatePointers,RTIBool allocateMemory);
