...
#ifndef SetpointMessage_986307871_h
#define SetpointMessage_986307871_h
...
RTIBool SetpointMessage_initialize_ex(
        SetpointMessage* self,RTIBool allocatePointers,RTIBool allocateMemory);
