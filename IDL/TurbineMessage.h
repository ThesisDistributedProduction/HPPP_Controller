...
#ifndef TurbineMessage_1893946751_h
#define TurbineMessage_1893946751_h
...
RTIBool TurbineMessage_initialize_ex(
        TurbineMessage* self,RTIBool allocatePointers,RTIBool allocateMemory);
