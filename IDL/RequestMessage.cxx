...
RTIBool RequestMessage_initialize_w_params(
    RequestMessage* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
...
void RequestMessage_finalize_w_params(
    RequestMessage* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
{
