...
#ifndef MaxProductionReachedMessage_94301377_h
#define MaxProductionReachedMessage_94301377_h
...
RTIBool MaxProductionReachedMessage_initialize_ex(
        MaxProductionReachedMessage* self,RTIBool allocatePointers,RTIBool allocateMemory);
...
#endif /* MaxProductionReachedMessage */
