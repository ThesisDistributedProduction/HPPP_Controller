...
RTIBool TurbineMessage_initialize_w_params(
    TurbineMessage* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
...
void TurbineMessage_finalize_w_params(
    TurbineMessage* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
{
