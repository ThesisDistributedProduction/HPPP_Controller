...
#ifndef TurbineDataMessage_1363016659_h
#define TurbineDataMessage_1363016659_h
...
RTIBool TurbineDataMessage_initialize_ex(
        TurbineDataMessage* self,RTIBool allocatePointers,RTIBool allocateMemory);
